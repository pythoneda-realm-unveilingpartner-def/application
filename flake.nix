...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-realm-unveilingpartner-infrastructure = {
      ...
      url = "github:pythoneda-realm-unveilingpartner-def/infrastructure/0.0.5";
    };
    pythoneda-realm-unveilingpartner-realm = {
      ...
      inputs.pythoneda-shared-pythoneda-domain.follows =
        "pythoneda-shared-pythoneda-domain";
      url = "github:pythoneda-realm-unveilingpartner-def/realm/0.0.3";
    };
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        repo = "application";
        version = "0.0.3";
        sha256 = "0gx2nw6d9nc0628kqbx0wwisjibyyg4lzcl2llv743jmnyn24j2j";
        pname = "${org}-${repo}";
