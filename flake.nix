...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-realm-unveilingpartner-infrastructure = {
      ...
      url = "github:pythoneda-realm-unveilingpartner-def/infrastructure/0.0.73";
    };
    pythoneda-realm-unveilingpartner-realm = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-realm-unveilingpartner-def/realm/0.0.60";
    };
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        repo = "application";
        version = "0.0.8";
        sha256 = "032pkv1l1phf8qw5acmlk1w95xd0yrfjw4mgbm683fvqfzsiwsbx";
        pname = "${org}-${repo}";
